...
import com.wolf.domain.ItemPedido;
import com.wolf.domain.Pagamento;
import com.wolf.domain.PagamentoComBoleto;
import com.wolf.domain.PagamentoComCartao;
import com.wolf.domain.Pedido;
import com.wolf.domain.Produto;
import com.wolf.domain.enums.EstadoPagamento;
...
import com.wolf.repositories.ItemPedidoRepository;
import com.wolf.repositories.PagamentoRepository;
import com.wolf.repositories.PedidoRepository;
...
public class DbService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "marcioloboti@gmail.com", "36378912377",
				TipoCliente.PESSOAFISICA, pe.encode("123"));

		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "mlobo.dev-test@gmail.com", "31628382740", TipoCliente.PESSOAFISICA,
				pe.encode("123"));
